...
\title{Gamma hadron separation with Deep Learning at the FACT telescope}
\date{2017}
\birthplace{Achim}
...
\input{content/02_theoretical_foundations.tex}
\input{content/03_network_architectures.tex}
